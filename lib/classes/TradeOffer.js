...
TradeOfferManager.prototype.getOffers = function(filter, historicalCutoff, callback) {
	...
	var options = {
		...
		"get_descriptions": false/*!!this._language*/,
		"language": this._language,
		"active_only": (filter == EOfferFilter.ActiveOnly || filter == EOfferFilter.All),
		"historical_only": (filter == EOfferFilter.HistoricalOnly || filter == EOfferFilter.All),
