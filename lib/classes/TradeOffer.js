...
TradeOffer.prototype.data = function (key, value) {
	...
	if (arguments.length < 2) {
		...
		return pollData.offerData?.[this.id] && pollData.offerData[this.id][key];
	}
		...
		"https://steamcommunity.com/tradeoffer/new/send",
		{
			headers: {
				referer: `https://steamcommunity.com/tradeoffer/${
					this.id || "new"
				}/?partner=${this.partner.accountid}${
...
TradeOffer.prototype.cancel = TradeOffer.prototype.decline = function (
	...
	this.manager._community.httpRequestPost(
		...
		{
			headers: {
				referer: `https://steamcommunity.com/tradeoffer/${this.id}/?partner=${
